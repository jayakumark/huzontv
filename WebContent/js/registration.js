	...
	if(facebook_code !== "")
	{
		...
		for(var a = 0; a < designations.length; a++)
		{
			...
			$("#" + designations[a].designation + "_facebook_link").click({value1: designations[a].designation},
					...
					docCookies.setItem("designation", event.data.value1, 31536e3);
					window.location.href = "https://www.facebook.com/dialog/oauth?client_id=176524552501035&redirect_uri=http://www.hoozon.tv/registration.html&scope=publish_actions&state=" + randomnumber;
					/*var oauth_token = null;
					$.ajax({
						type: 'GET',
						url: endpoint,
