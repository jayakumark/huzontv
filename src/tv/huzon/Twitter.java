...
public class Twitter {
	...
	public static void main(String[] args) {
		...
		while(it.hasNext())
		{
			...
			System.out.print("designation=" + currentreporter.getDesignation());
			try {
				System.out.println("\ttwitter_handle (from twitter)=" + 
						(twitter.verifyCredentials(currentreporter.getTwitterAccessToken(), currentreporter.getTwitterAccessTokenSecret())).getJSONObject("twitter_jo").getString("screen_name"));
